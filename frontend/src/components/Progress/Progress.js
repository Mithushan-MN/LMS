...
export default function ProgressComponent() {
  ...
  // const task2 = progressCardData.map((item2) =>
  // <ProgressCard tsk={item2.task} pcentage={item2.percentage}/>)

  const task = taskPosts.map((item) => 
  <ProgressCard tskname={item.taskName}/>)
        ...
        <div className="progress-content">
          ...
          <div className="progress-body">
            <div className="progress">
              <text>Deadline</text>
              {task}
              {/* {progressCardData.map((datas) =>{
                console.log();
                return(
                  // <ProgressCard tasks = {datas.task}/>
                  {task}
                )
              })} */}
            ...
            <div className="task">
              ...
              <div className="taskCompletedTopic">Task Completed(Hours)</div>
